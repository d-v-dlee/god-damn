---
title: "Review of Outlive by Peter Attia MD"
date: 2023-08-19
---
...
The vascular system is like a 60,000 mile network responsible for transporting nutrients, waste, and cholesterol between cells. Cholesterol is essential for cell membranes, hormones, bile acids, etc. but since its made out of fat (and fat and blood don't play nice), it requires lipoproteins to ferry it around. 

Lipoproteins are essentially proteins on the outside, fat on the inside. Markers on the external protein give it a "badge" to access certain areas. The primary difference between HDL ("good") and LDL ("bad") lies in their protein coat - LDL has apolipoprotein B (apoB) while HDL has apoA. ApoB's "badge" allows it to penetrate the endothelium (artery lining). If it then becomes oxidized, this can cause atheroscolerosis (build up and potentially blockage of the artery). This then causes additional inflammation and increases your risk for heart attacks.
